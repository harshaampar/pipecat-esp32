...
#define LOG_TAG "meeting-assistant"
...
typedef enum {
    MEETING_STATE_IDLE,
    MEETING_STATE_STARTING,
    MEETING_STATE_ACTIVE,
    MEETING_STATE_STOPPING
} meeting_state_t;
...
extern void pipecat_start_meeting();
extern void pipecat_stop_meeting();
extern bool pipecat_is_meeting_active();
...
extern void pipecat_screen_show_meeting_active(unsigned long duration_seconds);
